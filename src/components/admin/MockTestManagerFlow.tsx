        ...
        {qgTab === "auto" && (
          <div className="mt-4 space-y-4">
            <div className="grid gap-3 md:grid-cols-5">
              <div>
                <Label className="mb-1 block text-[11px] text-muted-foreground">Level</Label>
              ...
              <div>
                ...
                <Select value={String(qgQuestions)} onValueChange={(v) => setQgQuestions(Number(v))}>
                  <SelectTrigger className="h-9 rounded-xl border-white/10 bg-background/60"><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {[10, 20, 30, 50, 75, 100].map((q) => <SelectItem key={q} value={String(q)}>{q} MCQs</SelectItem>)}
                  </SelectContent>
                </Select>
              </div>
              <div>
                ...
                <Select value={qgSource} onValueChange={(v) => setQgSource(v as typeof qgSource)}>
                  <SelectTrigger className="h-9 rounded-xl border-white/10 bg-background/60"><SelectValue /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="random">Random (AI)</SelectItem>
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
              <div>
                <Label className="mb-1.5 block text-[11px] text-muted-foreground">Difficulty Mix</Label>
