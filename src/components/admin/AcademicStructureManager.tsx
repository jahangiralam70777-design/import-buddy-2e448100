  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-[1.6fr_1fr]">
        <ContentAnalyticsChart series={series} totals={aTotals} loading={analytics.isLoading} />
...
function ContentAnalyticsChart({ series, totals, loading }: { series: { day: string; views: number; attempts: number; users: number }[]; totals: { views: number; attempts: number; uniqueUsers: number }; loading: boolean }) {
